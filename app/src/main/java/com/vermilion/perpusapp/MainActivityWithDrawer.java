...
import com.vermilion.perpusapp.databinding.ActivityMainWithDrawerBinding;
...
public class MainActivityWithDrawer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_main_activity_with_drawer);
